...
// in myapp/test/settings_screen_test.dart.
...
import 'package:myapp/src/features/profile/data/repositories/profile_repository.dart'
    as _i3;
import 'package:myapp/src/features/profile/models/profile.dart' as _i2;
...
class MockProfileRepository extends _i1.Mock implements _i3.ProfileRepository {
  ...
  @override
  _i4.Future<void> updateProfile(_i2.Profile? profile) => (super.noSuchMethod(
        Invocation.method(
          #updateProfile,
          [profile],
        ),
